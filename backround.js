...
browser.storage.sync.get('blocklist').then(function(data) {
  if (data.blocklist) {
...
// Check if the request should be blocked based on the blocklist
function shouldBlockRequest(hostname) {
